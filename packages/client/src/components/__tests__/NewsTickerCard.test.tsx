...
import { NewsTickerCard } from "../NewsTickerCard";
...
describe("NewsTickerCard", () => {
  it("renders an empty state when there are no releases", () => {
    render(<NewsTickerCard onSendCommand={() => undefined} />);
  ...
  it("routes MML clicks in the headline through onSendCommand", () => {
    ...
    render(<NewsTickerCard onSendCommand={onSendCommand} />);
