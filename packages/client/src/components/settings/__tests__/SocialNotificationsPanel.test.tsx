/**
 * SocialNotificationsPanel — the thin front over the `notify` verb. Covers
 ...
 * and the card requests the projection on mount when none is cached.
 */
...
describe("SocialNotificationsPanel", () => {
  ...
  it("a control previews its notify command on hover and issues it on commit", () => {
    ...
    renderPanel({ onCommandPreview, onCommandClick });
