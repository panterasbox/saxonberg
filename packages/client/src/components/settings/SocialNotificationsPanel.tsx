/**
 * SocialNotificationsPanel — the "Social / Notifications" settings card, a
 ...
 *
 * The card is a **read-only cache + command issuer**: it reads the
...
export interface SocialNotificationsPanelProps {
  onClose: () => void;
