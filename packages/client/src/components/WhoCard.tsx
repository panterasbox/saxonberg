/**
 * WhoCard — the "Who's Online" right-column cockpit card (social-inspection
 ...
 * `services/websocket.ts`), and this card reads them reactively.
 *
 ...
 * stranger → a salient-feature description); the card only styles
...
export function WhoCard({
  onSendCommand,
  onCommandPreview,
}: WhoCardProps): React.ReactElement {
  const roster = useStore((s) => s.roster);
  const rosterOrder = useStore((s) => s.rosterOrder);

  return (
    <CardContainer aria-label="Who's Online">
      <Header>
