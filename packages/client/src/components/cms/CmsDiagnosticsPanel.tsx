/**
 * CmsDiagnosticsPanel — Reader B of the author-diagnostics subsystem: the
 * browser panel over the diagnostics store, beside the editor.
 *
 * Self-contained: the CMS tab opens no WebSocket, so the card polls
...
export const CmsDiagnosticsPanel: React.FC = () => {
