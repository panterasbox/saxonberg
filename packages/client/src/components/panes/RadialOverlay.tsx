 ...
 * therefore work on *every* named thing — the transcript, a pane's
 ...
 *
 * *Panes are caused by what you just did.* Acting on something through
...
import { openSubjectPane } from "./usePaneFeed";
...
/**
 * Which subject pane a composition calls for.
 *
 ...
 */
export function paneKindForComposition(
