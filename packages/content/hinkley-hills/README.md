...
The suburb **locality pack** (residences D18): the stop, the lane, the
plat and the lots — *The 'Burbs* by name. Package
`@saxonberg/content-hinkley-hills`; namespace root
`/world/terminus/hinkley-hills` (nested under the terminus pack's root;
