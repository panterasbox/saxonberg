...
function tissue(): Material {
  ...
  return makeStuffAtPath(() => {
    ...
    return m;
  }, `/stuff/idea/material/_test/bed-tissue-${matSeq}`) as unknown as Material;
}
...
function makePlant(short = 'a peace lily'): Plant {
  ...
  return makeStuffAtPath(() => {
    ...
    return p;
  }, `/trade/farming/thing/plant/_bedtest-${plantSeq}`);
}
...
function makeBed(soil: number, slots: number, water = 4): GardenBed {
  ...
  return makeStuffAtPath(() => {
    ...
    return bed;
  }, `/trade/farming/thing/bed/_test-${bedSeq}`);
}
...
function makePot(soil: number): PlantPot {
  ...
  return makeStuffAtPath(() => {
    ...
    return p;
  }, `/trade/farming/thing/pot/_bedtest-${potSeq}`);
}
