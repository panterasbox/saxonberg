...
import WikiRegistry from '../idea/WikiRegistry';
...
import { stubRegistries } from '../idea/api/__tests__/pack-harness';
...
describe('⚠ dangling subjects (51, 65)', () => {
  ...
  it('the article STILL RENDERS — the prose is the article (65)', async () => {
    ...
    const page = await create('oak', 'Oak is a hardwood.', {
      subject: { kind: 'template', ref: '/stuff/idea/material/gone' },
    });
