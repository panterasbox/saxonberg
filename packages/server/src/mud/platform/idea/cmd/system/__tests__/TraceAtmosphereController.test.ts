...
import TraceAtmosphereController from '../TraceAtmosphereController';
...
describe('TraceAtmosphereController', () => {
  beforeEach(() => {
    installV1QuantityMarshallers();
    installV1QuantityTagTables();
