 ...
 * (`/stuff/idea/biome/_defaultPressure`). Refuses in vacuum (atmospheric
...
import Altimeter from '../../../thing/instrument/Altimeter';
import Sextant from '../../../thing/instrument/Sextant';
