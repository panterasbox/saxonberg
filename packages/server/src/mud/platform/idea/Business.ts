 ...
 *
 * Seeded as domain data (`/world/lounge/idea/business`) and warmed / made
...
/**
 * BusinessEntity — the concrete seeded entity at `/world/lounge/idea/business`.
 ...
 * **default** so `class: /platform/idea/Business` resolves it (the `Bank`→`BankCounter`
