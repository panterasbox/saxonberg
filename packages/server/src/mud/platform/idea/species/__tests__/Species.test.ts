...
describe('Species', () => {
  ...
  it('cross-references resolve lazily via templatePath', () => {
    ...
    expect(sapiens._bodyPlanPath).toBe('/stuff/idea/species/BodyPlan/biped');
    expect(sapiens._parentCladePath).toBe('/stuff/idea/species/animalia');
    expect(sapiens._defaultMaterialPath).toBe('/stuff/idea/material/tissue/flesh');
