 ...
 * overlay state. Lives at `/platform/idea/StreamState`, sibling to the other
 ...
 * the seed YAML is `{ class: /platform/idea/StreamState, data: {} }`. A reboot
...
export default class StreamState extends StreamStateBase {
  ...
  public static readonly TEMPLATE_PATH = '/platform/idea/StreamState';
