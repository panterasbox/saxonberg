 ...
 *
 * Lives at `/platform/idea/CardRegistry`. The thin `CardApi` facade at
 ...
 * `/platform/idea/api/card`, and internal self-calls.
 *
...
const CardApiCallers = SecurityPolicies.AnyOf(
  ...
  SecurityPolicies.FromModule('/platform/idea/api/CardLogic#CardLogic'),
  SecurityPolicies.FromTemplate('/platform/idea/api/card'),
