...
describe('PackApi.orphans', () => {
  it('lists unstamped template rows only', async () => {
    store.rows.push(
      { _id: 'a', path: '/obj/OldThing', class: '/platform/thing/Prop', data: {}, __col: 'content' },
      { _id: 'b', path: '/obj/Stamped', class: '/platform/thing/Prop', data: {}, sourcePack: 'platform', __col: 'content' },
