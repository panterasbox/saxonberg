...
const IRON = '/stuff/idea/material/_test/sv-iron';
const LEATHER = '/stuff/idea/material/_test/sv-leather';
const COMPOSITE = '/stuff/idea/material/_test/sv-composite';
const RIGGED = '/stuff/idea/material/_test/sv-rigged';
