 ...
 * {@link SpeciesApi}.
 *
 * Lives at `/platform/idea/api/species` (a stateless `Stuff` singleton, no
...
export class SpeciesLogic extends ApiLogic {
  ...
  public async preloadAnatomy(actor: Stuff): Promise<void> {
    ...
    // template (e.g. `/stuff/idea/species/animalia/chordata/mammalia` —
  ...
  public async buildDossier(
    ...
    // the taxonomy (/stuff/idea/species/animalia/chordata/.../homo/<epithet>),
