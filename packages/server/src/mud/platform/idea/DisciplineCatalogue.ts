 ...
 * against.
 *
 * Lives at `/platform/idea/DisciplineCatalogue`, per the singleton-in-`obj/`
 * convention. The cache is transient instance state; the source of truth
 * is the per-Discipline leaf templates under
 * `/platform/idea/Discipline/` in the `content` collection. Discipline
 ...
 * /platform/idea/DisciplineCatalogue, data: {} }`.
 */
