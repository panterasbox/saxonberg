 ...
 * `/platform/idea/Topic/<dotted-path>`. The persistent prose fields
 * (`label`, `description`) are what the cockpit's filter drawer,
 * gutter tooltips, and future help system render. The catalogue
 * singleton (`/platform/idea/TopicCatalogue`) scans these instances at lookup
...
export default class Topic extends Idea {
   ...
   * `/platform/idea/Topic/<dotted-path>` — flat path strings; the
