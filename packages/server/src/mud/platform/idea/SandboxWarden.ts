...
import { SandboxLogic } from './api/SandboxLogic';
import { StuffApi } from '../../api/stuff';
import type { VetoResult } from '../../lib/errors';
import type { EvictionContext } from '../../lib/stuff/Stuff';

const SandboxWardenBase = PostRegistrationMixin(Idea);

export default class SandboxWarden extends SandboxWardenBase {
  ...
  public canDestruct(): VetoResult {
    return {
      ok: false,
      reason: 'SandboxWarden is a system singleton; never destructed',
    };
  }
