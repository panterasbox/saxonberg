 ...
 *
 * One canonical instance per templatePath at `/obj/LocomotionMode/<name>`.
 ...
 *   - Full templatePath (`/obj/LocomotionMode/walk`) — what
...
export class LocomotionMode extends SingletonMixin(PropertiedMixin(Idea)) {
  /** Short name (e.g. `'walk'`). The full templatePath is `/obj/LocomotionMode/<name>`. */
