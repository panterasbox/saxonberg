...
describe('ConditionApi.die — one transition', () => {
  ...
  it('caller-supplied attribution is used verbatim — the ledger never infers', async () => {
    ...
    const supplied: AccountabilityFields = {
      kind: 'death',
      sessionId: 'fight-1',
      initiator: '/obj/Avatar/mara',
      opponent: '/obj/Avatar/mara',
      victim: '/obj/Avatar/vic',
      killer: '/obj/Avatar/mara',
      lethality: 'lethal',
      consented: false,
      sentient: true,
    };
  ...
  it('attribution stamped on the dying record survives to the death row', async () => {
    ...
    const supplied: AccountabilityFields = {
      kind: 'death',
      sessionId: 'fight-2',
      initiator: '/obj/Avatar/rat',
      opponent: '/obj/Avatar/rat',
      victim: '/obj/Avatar/vic',
      killer: '/obj/Avatar/rat',
      lethality: 'lethal',
      consented: false,
      sentient: true,
    };
    ...
    expect(rows[0]!.killer).toBe('/obj/Avatar/rat');
  });
