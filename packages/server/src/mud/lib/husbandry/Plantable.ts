 ...
 * names the `/obj/plant/…` template this thing mints when planted. A
...
export interface Plantable {
  /** The `/obj/plant/…` template this mints when planted, or null. */
...
export function PlantableMixin<TBase extends MixinConstructor>(Base: TBase) {
  return class PlantableMixin extends Base implements Plantable {
    ...
    /**
     * The `/obj/plant/…` template this mints when planted.
     *
