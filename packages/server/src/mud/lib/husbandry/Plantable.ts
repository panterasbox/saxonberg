 ...
 * names the `/stuff/thing/plant/…` template this thing mints when planted. A
...
export interface Plantable {
  /** The `/stuff/thing/plant/…` template this mints when planted, or null. */
...
export function PlantableMixin<TBase extends MixinConstructor>(Base: TBase) {
  return class PlantableMixin extends Base implements Plantable {
    ...
    /**
     * The `/stuff/thing/plant/…` template this mints when planted.
     *
