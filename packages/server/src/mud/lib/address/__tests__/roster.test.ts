 ...
 *   /stuff/idea/Locality/narnia           Locality    ← root Region (fallback)
 *   /stuff/idea/Locality/cair-paravel     Locality    ← nested, longest-prefix
 *   /stuff/idea/Locality/lantern-waste    Locality    ← sibling discrimination
 *
 ...
 * naming):
 *
 *   /platform/idea/Locality/terminus            Locality  ← the transit hub
 *   /stuff/idea/Locality/the-lounge          Locality  ← the social hub
 *   /stuff/idea/Locality/last-counted-mile   Locality  ← the frontier crossroads
 */
...
const PLATFORM_DIR = join(dirname(__filename), '../../../../../../content/platform/content/platform/idea/Locality');
const SEEDS_DIR = join(dirname(__filename), '../../../../../../content/world-seed/content/stuff/idea/Locality');
...
describe('Address roster — slim demonstrative inventory', () => {
  it('the /platform/idea/Locality folder template is a FolderZone', () => {
  ...
  it('narnia is the root Region claiming the shortest prefix', () => {
    ...
    expect(seed.class).toBe('/platform/idea/Locality');
  ...
  it('the three transit-hub Localities name the TPA board destinations', () => {
    ...
    for (const f of ['terminus.yaml', 'the-lounge.yaml', 'last-counted-mile.yaml']) {
      expect(loadSeed(f).class).toBe('/platform/idea/Locality');
    }
  });
