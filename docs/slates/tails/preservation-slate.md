...
> on.
>
> Two slates point at this and stop: [mining](../builds/mining-slate.md) has
> **"Salt — the essential staple [DECIDED] … Preservation is the killer app"**,
> and [fishing](../builds/fishing-slate.md) names itself *"the natural driver to finally
...
[Economy](../builds/economy-slate.md)'s **Law 2 — *never tax absence; never demand
...
- **Environmental decay is a pre-named seam.** `Channel.ts` already announces
  ...
  [materials-response-slate](./materials-response-slate.md)
...
clock](../builds/ranching-slate.md).)*
...
[disease-slate](../builds/disease-slate.md) already specified, minus the hard half:
...
|---|---|---|---|
| **Salting / curing** | lowers water activity | **salt** ([mining](../builds/mining-slate.md)) | ⚠ **salt does not exist as a solid Material** — only `bulk/salt-water`, authored for the shock demo |
...
| **The growth term** | **ABSENT** — shared with [disease](../builds/disease-slate.md); build it **here** first |
