...
[fridge](../builds/fridge-design-pack.md) (the cold-store tier) ·
[room-condition](../builds/room-condition-design-pack.md) (the room this happens in) ·
...
[sanitation-slate](../builds/sanitation-slate.md) (*abandonment is an act*) ·
...
| | The heap |
|---|---|
| **Input** | spoiled food, kitchen scraps, [room-condition](../builds/room-condition-design-pack.md) debris |
...
It also gives [sanitation](../builds/sanitation-slate.md)'s *"abandonment is an act;
...
- **[Room-condition](../builds/room-condition-design-pack.md)** — debris is compost
...
- **[Sanitation](../builds/sanitation-slate.md)** — the heap is the domestic instance
...
5. **Does a hearth make a room a better place to recover mana?**
   [Mana](../builds/mana-economy-design-pack.md) ties recovery to ambient *mana*, not
