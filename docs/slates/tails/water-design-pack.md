...
> Same per-object format as the [room-condition](../builds/room-condition-design-pack.md),
...
slate](../builds/power-utility-slate.md) parked. Under the [recurring-charge
...
[power slate](../builds/power-utility-slate.md)'s **middle tier** — the supply-ref —
...
| ⭐⭐ **Contaminated** | it runs, and it makes you ill | [disease-slate](../builds/disease-slate.md) |
...
[room-condition](../builds/room-condition-design-pack.md) Part 4 already cites
...
| ✳ **Supply-ref for water** | dry / frozen / contaminated source states | **rides [power-utility](../builds/power-utility-slate.md)'s middle tier** |
| ✳ **Contaminated → disease** | a source-borne route | **rides [disease](../builds/disease-slate.md)** |
...
>
> ✅ **Resolved by [supply-design-pack § Part 4](../builds/supply-design-pack.md):
...
- **[Disease-slate](../builds/disease-slate.md)** — the contamination route.
- **[Power-utility](../builds/power-utility-slate.md)** — the shared supply-ref shape;
