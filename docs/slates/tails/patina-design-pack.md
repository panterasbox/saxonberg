...
worked example) · [room-condition](../builds/room-condition-design-pack.md) ·
...
relationship lives in [pets](../builds/pets-slate.md). An object's best possible
...
field — the same move the [mana pack](../builds/mana-economy-design-pack.md) made
...
5. **Should a *place* take patina?** A well-kept workshop, a much-used kitchen.
   ...
   [room-condition](../builds/room-condition-design-pack.md) already warns about that.
