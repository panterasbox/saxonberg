...
> as the [fridge pack](../builds/fridge-design-pack.md).
...
[disease-slate](../builds/disease-slate.md) (**inherits this growth term**) ·
...
- **The disease bridge** — it is *literally* the same equation as
  [disease-slate](../builds/disease-slate.md) minus transmission. A student who
