...
> antipattern row.
>
> Companions: [lineage-slate](../builds/lineage-slate.md) (seeded claims as
> upbringing), [psychology-slate](../builds/psychology-slate.md) (the vocation
> this must not break).
...
[psychology-slate](../builds/psychology-slate.md) is spent.
...
The [species slate](../builds/species-slate.md) lists *"culture as biology —
...
- the trait narrator describes an **act** by how far it sits from your
  equilibrium
- the [lineage](../builds/lineage-slate.md) gallery card describes a **person**
...
- **Cross-axis propagation** and the richer compatibility kernel — still
  deferred, unaffected.
- **The psychology vocation itself** — [psychology-slate](../builds/psychology-slate.md)
...
- [advancement.md](../../subsystems/advancement.md) — the shared
  ...
  lack
- [psychology-slate](../builds/psychology-slate.md) — you cannot read yourself;
  disclosure is discovery; the stale "privacy is free" note
- [species-slate](../builds/species-slate.md) — costs-not-ranks, incomparability,
  and the "culture as biology" antipattern this bounds
- [lineage-slate](../builds/lineage-slate.md) — seeded claims as upbringing;
...
- [balance-slate](../builds/balance-slate.md) — every global ledger is a
