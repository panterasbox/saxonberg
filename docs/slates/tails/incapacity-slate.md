...
rule** this reuses), [sanitation-slate](../builds/sanitation-slate.md)
(*abandonment is an act; impound not destroy* — the precedent),
[prison-slate](../builds/prison-slate.md) (the confinement case),
[balance-slate](../builds/balance-slate.md) (the standing ladder; the
sweep-proliferation warning), [governance.md](../../subsystems/governance.md)
(offices, already solved),
[amendment-library-slate](../builds/amendment-library-slate.md) (Amdt 25).
...
[sanitation-slate](../builds/sanitation-slate.md) already settled for abandoned
