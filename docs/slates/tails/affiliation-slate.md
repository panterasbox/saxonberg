...
| **Religion** | faith/deity → [alignment](../builds/alignment-slate.md) | chosen | deep (deity drama) | the deity pick |
...
[alignment-slate](../builds/alignment-slate.md) (religion;
corp-competition's prosocial caveat) · [char-gen](../../subsystems/char-gen.md)
(house is the onboarding touch; aspiration→major→guild) ·
[capability-magic](../builds/capability-magic-slate.md) (guild = the class system) ·
