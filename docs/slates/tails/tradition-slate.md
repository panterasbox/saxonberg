...
>
> **It rides [inquiry-slate.md](../builds/inquiry-slate.md) and adds almost
...
- [inquiry-slate.md](../builds/inquiry-slate.md) — **the owner of the machinery.**
...
- [deduction-slate.md](../builds/deduction-slate.md) — the shared hard line:
...
- [discovery-slate.md](../builds/discovery-slate.md) — the almanac, the
...
⚠ **`Law` is [inquiry](../builds/inquiry-slate.md)'s object, not this slate's** —
...
[inquiry-slate](../builds/inquiry-slate.md)'s open questions cover catalog
