...
- [docs/slates/access-slate.md](./access-slate.md) — the **authoritative
...
- **The access gate / leases / op model** → [access-slate.md](./access-slate.md).
...
- **The content-editor forms** → [cms-slate.md](./cms-slate.md) (they share
  ...
  CMS's).
- **Host isolation / running untrusted code** → [access-slate.md](./access-slate.md);
  deferred.
