...
- [docs/slates/senses-slate.md](./senses-slate.md) /
  [fast-travel-slate.md](./fast-travel-slate.md) — **discovery / fog-of-war**
  for the game minimap (show only what the player has perceived/discovered);
  wayfinding.
- [docs/slates/access-slate.md](./access-slate.md) — the editor map reads
...
- **The cockpit / HUD layout** → [client-cockpit-slate.md](./client-cockpit-slate.md).
