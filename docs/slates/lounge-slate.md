...
[MultiLocation](./multilocation-slate.md) `Warren`) rooted at a persistent
...
5. **Dave's Bar is the anti-lounge because it's a craft economy, not a
   ...
   [vitals](./vitals-slate.md) consumables; the bar authors only the menu.
...
- [docs/slates/multilocation-slate.md](./multilocation-slate.md) — **the
...
- [docs/slates/fast-travel-slate.md](./fast-travel-slate.md) — **the exit.**
...
- [docs/slates/onboarding-slate.md](./onboarding-slate.md) — the lounge is
...
- [docs/slates/char-gen-slate.md](./char-gen-slate.md) — one (optional)
  front-end for seeding the flavor tag-set at intake.
- [docs/slates/npc-dialogue-slate.md](./npc-dialogue-slate.md) — **Dave.**
...
- [docs/slates/vitals-slate.md](./vitals-slate.md) — **drinks.** A drink is
...
The lounge is a [MultiLocation](./multilocation-slate.md): a persistent
...
**Drinks are [vitals](./vitals-slate.md) consumables.** The bar authors
...
- **Onward routing** — first-time vs returning is the **TPA terminal's**
  state-routing ([fast-travel](./fast-travel-slate.md)): onboarded flag →
...
[MultiLocation substrate](./multilocation-slate.md) (`route` dual-objective
...
- **The MultiLocation substrate** — the `Warren` / host / member /
  budding / merging / recall machinery → [multilocation-slate.md](./multilocation-slate.md).
  The lounge is its consumer.
- **Drink effects** (intoxication, hydration, the consumable delivery) →
  [vitals-slate.md](./vitals-slate.md). The bar authors only the menu.
- **The fast-travel network** (terminals, routes, scan-to-register, the
  credential) → [fast-travel-slate.md](./fast-travel-slate.md); the lounge
  merely hosts the first terminal.
- **NPC dialogue internals** (responder seam, trees, scripted matching,
  the LLM front-end) → [npc-dialogue-slate.md](./npc-dialogue-slate.md);
  Dave consumes it.
- **Char-gen intake** and the **campus journey / dorm payoff** →
  [char-gen-slate.md](./char-gen-slate.md) / [onboarding-slate.md](./onboarding-slate.md).
