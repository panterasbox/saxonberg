...
- [docs/slates/access-slate.md](./access-slate.md) — brains live in
...
- **The dialogue *responders* internals** → [npc-dialogue-slate.md](./npc-dialogue-slate.md);
...
- **Scripting itself** (the general code-tier behavior + the sandbox/
  isolation) → the deferred scripting work + [access-slate.md](./access-slate.md);
