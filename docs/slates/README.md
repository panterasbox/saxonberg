...
**Phases:** vitals substrate (built → tails) → encumbrance (built → tails) → metabolism (built → tails) → **thermal (built → tail)** → [respiration · weather — deferred behind content / the addressing substrate].
