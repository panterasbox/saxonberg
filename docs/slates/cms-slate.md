...
- [docs/slates/access-slate.md](./access-slate.md) — **the backend.** The
...
- [docs/slates/client-cockpit-slate.md](./client-cockpit-slate.md) — the play
...
- [docs/slates/char-gen-slate.md](./char-gen-slate.md) — the
...
- **The access / lease model, the holodeck, versioning/audit** →
  [access-slate.md](./access-slate.md). The CMS *consumes* all of it.
...
- **The play client / cockpit rendering** →
  [client-cockpit-slate.md](./client-cockpit-slate.md). The CMS shares the
