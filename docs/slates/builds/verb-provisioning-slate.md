...
- [docs/slates/recognition-slate.md](../builds/recognition-slate.md) — actor
...
- [docs/slates/mixin-slate.md](../tails/mixin-slate.md) — skill-as-mixin and
...
[recognition-slate.md](../builds/recognition-slate.md)), or a calibrated
