...
void extra_create()
{
    ...
    set( "day_long",
      "You're standing at the northern edge of a vast wheatfield.  All around you "
      "(except to the north) row after row of the proverbial amber waves "
      "of grain stretch to the horizon.  However, to your north is "
      "a huge wall of gray granite.  This cliff face extends "
    ...
    set(OutsideP,1);
    set("exits", ([
	"west":"/zone/null/eternal/school/farm/wheat01",
	"east":"/zone/null/eternal/school/farm/wheat03",
	"south":"/zone/null/eternal/school/farm/wheat12",
	"southeast":"/zone/null/eternal/school/farm/wheat13",
	"southwest":"/zone/null/eternal/school/farm/wheat11",
      ]) );
}
