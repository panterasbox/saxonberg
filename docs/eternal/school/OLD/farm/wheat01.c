...
void extra_create()
{
    ...
    set( "day_long",
      "You are at the northern edge of a huge field of wheat.  The field ends "
      "abruptly to the north at a blank, granite cliff face."
      "  The rows of wheat stretch as far as your eye can see in every other direction."
    );
    set("descs", ([
    ...
    set(OutsideP,1);
    set("exits", ([
	"west":"/zone/null/eternal/school/farm/wheat00",
	"east":"/zone/null/eternal/school/farm/wheat02",
	"south":"/zone/null/eternal/school/farm/wheat11",
	"southeast":"/zone/null/eternal/school/farm/wheat12",
	"southwest":"/zone/null/eternal/school/farm/wheat10",
      ]) );
}
