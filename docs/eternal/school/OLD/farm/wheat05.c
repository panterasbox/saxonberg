...
void extra_create()
{
    ...
    set( "day_long",
      "As you emerge from between the rows of wheat, you arrive face to face "
      "with an impenetrable wall of solid granite.  This tremendous cliff face "
      "stretches to the east and west for as far as you can see, blocking "
      "any further passage to the north.  Surrounding you to all other "
      "directions are innumerable rows of golden wheat."
    );
    set("descs", ([
    ...
    set(OutsideP,1);
    set("exits", ([
	"west":"/zone/null/eternal/school/farm/wheat04",
	"east":"/zone/null/eternal/school/farm/wheat06",
	"south":"/zone/null/eternal/school/farm/wheat15",
	"southeast":"/zone/null/eternal/school/farm/wheat16",
	"southwest":"/zone/null/eternal/school/farm/wheat14",
      ]) );
}
