...
void extra_create()
{
    ...
    set( "day_long",
      "Immediately to your north stands an immense wall of solid granite.  This cliff face "
      "stretches as far as you can see to the east and west and prohibits any further "
      "travel to the north.  All around you are furrows of unseeded soil.  The soil is "
      "warm and moist and you can see your tracks trailing behind you.  The open field "
    ...
    set(OutsideP,1);
    set("exits", ([
	"west":"/zone/null/eternal/school/farm/wheat07",
	"east":"/zone/null/eternal/school/farm/wheat09",
	"south":"/zone/null/eternal/school/farm/wheat18",
	"southeast":"/zone/null/eternal/school/farm/wheat19",
	"southwest":"/zone/null/eternal/school/farm/wheat17",
      ]) );
}
