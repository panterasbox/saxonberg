...
void extra_create()
{
   ...
   set( "day_long",
      "You're standing in furrows of freshly tilled earth.  There "
      "is a vast field of wheat directly to your west.  To the "
      "north, the field continues until it hits a steep cliff face which "
      "runs to the east and west.  The tilled earth continues to the east."
    );
   set("descs", ([
   ...
   set("exits", ([
	   "north":ROOMS+"wheat17",
	   "northeast":ROOMS+"wheat18",
	   "northwest":ROOMS+"wheat16",
	   "west":ROOMS+"wheat26",
	   "east":ROOMS+"wheat28",
      ]) );
}
