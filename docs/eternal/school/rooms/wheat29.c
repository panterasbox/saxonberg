...
void extra_create()
{
   ...
   set("descs", ([
	   ({ "cliff", "face", "cliff face" }) :
	      ...
	      "you see something floating along up there.  It's not a bird, "
	      "it's not a star...  What could it be?",
   ...
   ({"river","river bank","bank"}) :
      "This swollen, rapidly flowing river looks frighteningly difficult "
