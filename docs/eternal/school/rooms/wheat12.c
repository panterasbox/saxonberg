...
void extra_create()
{
   ...
   set( "day_long",
      "You are standing in an immense field of wheat.  To the south, "
      "west, and east, the rows of wheat stretch out as far as you can "
      "see.  To the north, in the distance, you can see what appears "
   ...
   set("exits", ([
	   "north":ROOMS+"wheat02",
	   "northwest":ROOMS+"wheat01",
	   "northeast":ROOMS+"wheat03",
	   "west":ROOMS+"wheat11",
	   "east":ROOMS+"wheat13",
	   "south":ROOMS+"wheat22",
	   "southeast":ROOMS+"wheat23",
	   "southwest":ROOMS+"wheat21",
      ]) );
}
