...
void extra_create()
{
   ...
   set( "day_long",
      "You are standing at the northeastern corner of the wheatfield.  "
      "This part of the field has been left fallow for the season and "
      "furrows of soil surround you.  To the east lies a wide river, "
      "probably more than a mile across at this point.  You can see no "
      "way to get across.  The river runs north and south, as far as you "
      "can see.  To your north is an impassable cliff face of solid "
      "granite.  The cliff runs to the west into the distance.");
   set("descs", ([
	   ...
	   ({"river", "water" }) :
	      ...
	      "in sight, and you can't imagine trying to build one yourself.  "
	      "And the current seems to be extraordinarily swift, to the point "
	      "where swimming would be next to impossible.",
      ]) );
   set(OutsideP, 1);
   set(NoPKP, 1);
   set(NoTeleportInP, 1);
