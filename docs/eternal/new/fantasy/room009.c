...
#define DAY_LONG\
  ...
  "west.  Beneath you, the material from which the street is paved " \
  "glitters brightly.  Every step you take rings off its surface and " \
  "is lost in the city's atmosphere."
