...
#define DAY_LONG\
  "You are on a road covered with black gravel.  A rambling, " \
  "wooden building lies with its door open to the east.  " \
  "Tanelorn Road continues to the north and south, as does " \
  "the cliff edge pacing it to the west.  The smooth curve " \
  "of the Shield seems to be interrupted to the north by a " \
  "large, stone archway."
