...
association declaration. The rules pinned to a chat server. Each of them has the same two
layers: the rules themselves, and the settings filled in around them.
...
The clearest case of an amendment-tier change ran both ways. The United States prohibited
alcohol by constitutional amendment in 1919, and repealed that amendment in 1933 — the
same instrument and the same threshold, used to install a policy and then to remove it.
