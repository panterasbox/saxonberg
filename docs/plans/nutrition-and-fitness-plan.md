...
`packages/wire/tests/nutrition-fitness.dirty.wire.test.ts`, run with `WIRE_BOOT=1` on a freshly dropped `saxonberg_build3` (2026-09-18, six runs). **Final: 21 passed, 1 skipped (step 7 — heat, build-4 unmerged), 0 failed.** The first run was **8/22**. What the runs found, in order:
