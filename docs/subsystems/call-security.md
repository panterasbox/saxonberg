...
| Class                                                 | Module ID                                     |
| ----------------------------------------------------- | --------------------------------------------- |
| `class Foo` exported as `Foo`                         | `mud/lib/Foo#Foo`                             |
| `class Foo` exported as `default`                     | `mud/lib/Foo` (bare path is the default-export convention) |
| `class StuffApi` in `mud/api/stuff.ts`                | `mud/api/stuff#StuffApi`                      |
| `class NarniaLocation` in `mud/domain/narnia/...`     | `mud/domain/narnia/NarniaLocation#NarniaLocation` |
