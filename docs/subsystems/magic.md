...
| Spell | `lib/magic/Spell.ts` (data-Idea) + `obj/SpellCatalogue.ts` | authored roster leaves under `/lib/magic/Spell/<spellId>`, boot-warmed (the Discipline/Corpo recipe), **no Mongo collection** |
